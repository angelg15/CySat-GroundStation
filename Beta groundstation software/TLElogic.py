...
def initDateTime(Name, Line1, Line2):
	
	N = Name.strip()
	L1 = Line1.strip()
	L2 = Line2.strip()
	
	iss = ephem.readtle(N, L1, L2)
	obs = ephem.Observer()
	obs.lat = '42.02690'
	obs.long = '-93.65278'
	iss.compute(obs)
...
NT = 'ISS (ZARYA)'
L1T = '1 25544U 98067A   17056.55314480 -.00004112  00000-0 -54130-4 0  9996'
L2T = '2 25544  51.6401 234.7956 0006312 234.6177 237.0398 15.54451179 44391'

initDateTime(NT,L1T,L2T)
